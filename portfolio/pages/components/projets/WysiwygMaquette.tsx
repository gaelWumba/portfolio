    ...
    <div className="flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
      <div className="-mb-20 md:mb-0 flex-shrink-0 object-cover md-rounded-lg md-w-64 md-h-95">
        <div className="group [perspective:1000px] ">
          <div className="transition-all duration-1000 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] w-[520px] h-[600px] rounded-3xl border-[1px] border-[#499FF4]">
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-[#499FF4] [transform:rotateY(180deg)] [backface-visibility:hidden] w-[520px] h-[600px] rounded-3xl border-[1px] border-[#499FF4]">
